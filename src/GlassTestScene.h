...
class GlassTestScene : public Scene
{
public:
    GlassTestScene(int width, int height) 
        : Scene(width, height)
    {
        ...
        // Lighting
        Light* l1 = new PointLight(glm::vec3(1000,1000, (back - front)/2.0f), glm::vec3(1,1,1), 1.0f);
        ...
        std::shared_ptr<Material> m2 = std::make_shared<Material>(Glass(glm::vec3(0,0,0), 1.5f, 0.2));
        float rsph2 = 50;
        Sphere* sph2 = new Sphere(glm::vec3(0,top - abs(bottom),200), rsph2, m2);
