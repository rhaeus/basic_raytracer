...
Scene::Scene()
{
    ...
    // Material* m1 = new Shiny(glm::vec3(0.6,0.5,0.9), 100, 0.9f);.
    Material* m1 = new Shiny(glm::vec3(0,1,0), 50, -1.0f);
    // Material* m1 = new Flat(glm::vec3(0.6,0.2,0.9));
    // Material* m1 = new Mirror(1.0f);
    // Material* m1 = new Glass(glm::vec3(0,0,0), 1.5f, 50.0f);
    Sphere* sph1 = new Sphere(glm::vec3(0,0,500), 200, std::shared_ptr<Material>(m1));
    objects.push_back(std::shared_ptr<Renderable>(sph1));

    Material* m2 = new Glass(glm::vec3(0,0,0), 1.5f, 50.0f);
    Sphere* sph2 = new Sphere(glm::vec3(0,0,15), 3, std::shared_ptr<Material>(m2));
    // objects.push_back(std::shared_ptr<Renderable>(sph2));

    // Material* m3 = new Shiny(glm::vec3(0,0,1), 50);
    // Sphere* sph3 = new Sphere(glm::vec3(0,-8.5,12), 1.5, std::shared_ptr<Material>(m3));
    ...
    Triangle* left_t1 = new Triangle(glm::vec3(left,bottom,front), glm::vec3(left,bottom,back), glm::vec3(left, top, back), std::shared_ptr<Material>(left_m));
    Triangle* left_t2 = new Triangle(glm::vec3(left,bottom,front), glm::vec3(left,top,back), glm::vec3(left, top, front), std::shared_ptr<Material>(left_m));
    ...
    Material* back_m = new Flat(glm::vec3(1,1,0));
    Triangle* back_t1 = new Triangle(glm::vec3(left,bottom,back), glm::vec3(right,bottom,back), glm::vec3(right, top, back), std::shared_ptr<Material>(back_m));
    Triangle* back_t2 = new Triangle(glm::vec3(left,bottom,back), glm::vec3(right,top,back), glm::vec3(left, top, back), std::shared_ptr<Material>(back_m));
    ...
    Material* front_m = new Flat(glm::vec3(1,1,1));
