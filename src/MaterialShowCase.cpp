    ...
    : Scene(width, height)
{
    ...
    // camera = Camera(glm::vec3(0,10000000,500), glm::vec3(0,1,0), glm::vec3(0,0,500), 60, width, height);
    ...
    // shiny
    // uni
    std::shared_ptr<Material> m7 = std::make_shared<Shiny>(Shiny(glm::vec3(232/255.0f, 182/255.0f, 0), 250, 0.05));
    float rsph7 = 100;
    ...
    // bumpy
    std::shared_ptr<Material> m9 = std::make_shared<Shiny>(Shiny(glm::vec3(0/255.0f, 232/255.0f, 128/255.0f), 50, 0.2));
